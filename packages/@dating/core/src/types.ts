...
export interface UserProfile {
  ...
  // ── Telegram account settings (read-only, not stored in our DB) ──
  /** True if this Telegram user has "charge for messages" enabled in their Telegram settings */
  chargesForMessages?: boolean
